...
def GenerateCertificatePDFintoSVGMovil(questions_mtto, JSONquestion_views, questions_deterioration, tank_identification,
   ...
   # Crear un objeto BytesIO para guardar la imagen en memoria
    ...
    workbook = openpyxl.load_workbook('reporttankmovil/tpCertificadoMovil.xlsx')   
    ...
    if JSONtank_identification['valvulaAlivio']['cumple']== True:
     hoja['G31'] = 'CUMPLE'
      ...
      hoja['G31'] = 'NO CUMPLE'
    #conexiones
    if JSONtank_identification['EstadoConexionCorrosion']['cumple']== True & JSONtank_identification['EstadoConexionEvidenciaGolpes']['cumple']== True &  JSONtank_identification['EstadoConexionDesgaste']['cumple']== True &  JSONtank_identification['EstadoConexionOtros']['cumple']== True:
     hoja['G32'] = 'CUMPLE'
    else:
     hoja['G32'] = 'NO CUMPLE'
