...
def GeneratePDFintoSVGMovil(questions_mtto, question_views, questions_deterioration, tank_identification,
    ...
    print(companie)
    workbook = openpyxl.load_workbook('reporttankmovil/tpMovil.xlsx')    
   ...
   #hermeticidad
    ...
    workbook.save(f'reporttankmovil/xlxs/reporte_tanque_movil_QC_{id}.xlsx')
      # Offer the PDF file for download    
    input_excel =  f'reporttankmovil/xlxs/reporte_tanque_movil_QC_{id}.xlsx' 
    output_pdf = f'reporttankmovil/pdfs'
    ...
    pdf_path = os.path.join(settings.BASE_DIR, 'reporttankmovil','pdfs', pdf_filename)
    print(pdf_path)
